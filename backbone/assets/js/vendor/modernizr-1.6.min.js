...
window.Modernizr = function(i, e, u) {
      ...
      for (var b = 0, c, k = a.length; b <
        ...
        if (c = h.type !== "text") {
          ...
          if (/^range$/.test(h.type) && h.style.WebkitAppearance !== u) {
            l.appendChild(h);
            c = e.defaultView;
            c = c.getComputedStyle && c.getComputedStyle(h, null)
              .WebkitAppearance !== "textfield" && h.offsetHeight !== 0;
            l.removeChild(h)
  ...
  d.canvastext = function() {
    return !!(f.canvas && typeof e.createElement("canvas")
      .getContext("2d")
      .fillText == "function")
  };
  d.webgl = function() {
  ...
  d.cssgradients =
    function() {
      var a = ("background-image:" + q.join("gradient(linear,left top,right bottom,from(#9f9),to(white));background-image:") + q.join("linear-gradient(left top,#9f9, white);background-image:"))
        .slice(0, -17);
      j.cssText = a;
...
"MozPerspective", "OPerspective", "msPerspective"]);
  ...
  i.attachEvent && function() {
    ...
    a.attachEvent("onbeforeprint", function() {
      ...
      B.styleSheet.cssText = k(b.styleSheets, "all")
        .replace(T, ".iepp_$1");
