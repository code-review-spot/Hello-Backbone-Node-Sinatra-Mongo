...
exports.parseCookie = function(str) {
  ...
  for (var i = 0, len = pairs.length; i < len; ++i) {
    var pair = pairs[i],
      ...
      key = pair.substr(0, eqlIndex)
        .trim()
        .toLowerCase(),
      val = pair.substr(++eqlIndex, pair.length)
        .trim();
...
exports.modified = function(req, res, headers) {
  var headers = headers || res._headers || {}, modifiedSince = req.headers['if-modified-since'],
