...
exports.shouldCorrectlyEmitErrorOnAllDbsOnPoolClose = function(test) {
  if (process.platform !== 'linux') {
    var db = new Db('tests', new Server("127.0.0.1", 27027, {
      auto_reconnect: true
    }), {
      native_parser: (process.env['TEST_NATIVE'] != null)
    });
...
exports.shouldCorrectlyUseSameConnectionsForTwoDifferentDbs = function(test) {
  var second_test_database = new Db(MONGODB + "_2", new Server("127.0.0.1", 27017, {
    auto_reconnect: true,
    ssl: useSSL
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null),
...
exports.shouldCorrectlyShareConnectionPoolsAcrossMultipleDbInstances = function(test) {
  ...
  db.open(function(err, db) {
    ...
    multipleColl1.insert({
      a: 1
    }, {
      safe: true
    }, function(err, result) {
      multipleColl2.insert({
        a: 1
      }, {
        safe: true
      }, function(err, result) {
