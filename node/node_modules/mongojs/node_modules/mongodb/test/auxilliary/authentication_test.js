...
exports.shouldCorrectlyAuthenticate = function(test) {
  ...
  var db2 = new Db('mongo-ruby-test-auth2', new Server("127.0.0.1", 27017, {
    auto_reconnect: true
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null)
  });
  var admin = new Db('admin', new Server("127.0.0.1", 27017, {
    auto_reconnect: true
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null)
  });
  ...
  Step(
    ...
    function restartServerInAuthMode(err, result) {
      test.equal(null, err);
      test.equal('7c67ef13bbd4cae106d959320af3f704', result.shift()
        .pwd);
    ...
    function authenticateAdminUser(err) {
      ...
      db1.admin()
        .authenticate('admin', 'admin', this.parallel());
      db2.admin()
        .authenticate('admin', 'admin', this.parallel());
    },
