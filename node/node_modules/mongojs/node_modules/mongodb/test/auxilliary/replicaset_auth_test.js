...
var testCase = require('../../deps/nodeunit')
  ...
  ReplicaSetManager = require('../../test/tools/replica_set_manager')
    .ReplicaSetManager,
  ...
  db.open(function(err, p_db) {
    Step(
      ...
      function changePassword(err, result) {
        ...
        db.admin()
          .addUser("me", "secret2", this);
      },

      function authenticate(err, result) {
        db.admin()
          .authenticate("me", "secret2", this);
      },
      ...
      function sameShouldApplyToRandomSecondaryServer(err, result) {
        ...
        slaveDb = new Db('foo', new Server(db.serverConfig.secondaries[0].host, db.serverConfig.secondaries[0].port, {
          auto_reconnect: true,
          poolSize: 1
        }), {
          native_parser: (process.env['TEST_NATIVE'] != null),
