var mongo = require('mongodb'),
  ...
  primary1 = new mongo.Server('127.0.0.1', 30000, {
    auto_reconnect: true,
    poolSize: 5
  }),
  secondary1 = new mongo.Server('127.0.0.1', 30001, {
    auto_reconnect: true,
    poolSize: 5
  }),
  primary2 = new mongo.Server('127.0.0.1', 30000, {
    auto_reconnect: true,
    poolSize: 5
  }),
  secondary2 = new mongo.Server('127.0.0.1', 30001, {
    auto_reconnect: true,
    poolSize: 5
  }),
