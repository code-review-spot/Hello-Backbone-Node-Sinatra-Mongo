...
var testCase = require('../deps/nodeunit')
  ...
  Db = mongodb.Db,
  ObjectID = require('../lib/mongodb/bson/objectid')
    .ObjectID,
  DBRef = require('../lib/mongodb/bson/db_ref')
    .DBRef,
  Code = require('../lib/mongodb/bson/code')
    .Code,
...
var client = new Db(MONGODB, new Server("127.0.0.1", 27017, {
  auto_reconnect: true,
  poolSize: 4,
  ssl: useSSL
}), {
...
exports.setUp = function(callback) {
  ...
  client.open(function(err, db_p) {
    if (numberOfTestsRun == (Object.keys(self)
      .length)) {
...
exports.shouldCorrectlyPerformAutomaticConnect = function(test) {
  var automatic_connect_client = new Db(MONGODB, new Server("127.0.0.1", 27017, {
    auto_reconnect: true,
    ssl: useSSL
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null),
...
exports.shouldCorrectlyRetrieveCollectionInfo = function(test) {
  ...
  db.open(function(err, db) {
    ...
    db.createCollection('test_collections_info', function(err, r) {
      ...
      db.collectionsInfo("test_collections_info")
...
exports.shouldCorrectlyAccessACollection = function(test) {
  ...
  db.open(function(err, db) {
    ...
    db.collection('test_correctly_access_collections', function(err, col2) {
      ...
      db.collection('test_correctly_access_collections', {
        safe: true
      }, function(err, col3) {
        test.ok(err != null);
...
exports.shouldCorrectlyHandleFailedConnection = function(test) {
  var fs_client = new Db(MONGODB, new Server("127.0.0.1", 27117, {
    auto_reconnect: false,
    ssl: useSSL
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null)
    ...
    client.createCollection('test_resave_dbref', function(err, collection) {
      ...
      collection.insert({
        ...
        collection.insert(child, {
          ...
          collection.findOne({
            'name': 'child'
          }, function(err, child) { //Child deserialized
            test.ifError(err);
            test.ok(child != null);
...
exports.shouldCorrectlyRenameACollection = function(test) {
  ...
  db.open(function(err, db) {
    ...
    // Create a collection
    db.createCollection("simple_rename_collection", {
      safe: true
    }, function(err, collection) {
      test.equal(null, err);
...
exports.shouldCorrectlyUsePreviousError = function(test) {
  ...
  db.open(function(err, db) {
    ...
    // Create a collection
    db.createCollection("simple_previous_error_coll", {
      safe: true
    }, function(err, collection) {
      test.equal(null, err);
...
exports.shouldCorrectlyUseResetErrorHistory = function(test) {
  ...
  db.open(function(err, db) {
    ...
    // Create a collection
    db.createCollection("simple_reset_error_history_coll", {
      safe: true
    }, function(err, collection) {
      test.equal(null, err);
  ...
  db.open(function(err, db) {
    ...
    db.createCollection('more_complex_ensure_index_test', function(err, collection) {
      ...
      collection.insert([{
        ...
        // Create an index on the a field
        db.ensureIndex('more_complex_ensure_index_test', {
          a: 1,
          b: 1
        }, {
          unique: true,
  ...
  db.open(function(err, db) {
    ...
    db.createCollection('cursor_information_collection', function(err, collection) {
      ...
      for (var i = 0; i < 1000; i++) {
        docs.push({
          a: 'hello world hello world hello world hello world hello world hello world hello world hello world'
        });
      }
 ...
 * @ignore
 */
var numberOfTestsRun = Object.keys(this)
  .length - 2;