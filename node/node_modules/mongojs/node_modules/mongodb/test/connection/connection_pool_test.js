...
var testCase = require('../../deps/nodeunit')
  ...
  fs = require('fs'),
  ConnectionPool = require('../../lib/mongodb/connection/connection_pool')
    .ConnectionPool;
...
exports['Should Correctly create a pool instance with the expected values'] = function(test) {
  var connectionPool = new ConnectionPool('localhost', 2000, 1, null, {
    timeout: 100,
    noDelay: true
  });
...
exports['Should correctly fail due to no server'] = function(test) {
  var connectionPool = new ConnectionPool('localhost', 2000, 4, null, {
    timeout: 100,
    noDelay: true
  });
...
exports['Should Correctly create a pool of connections and receive an ok when all connections are active'] = function(test) {
  var connectionPool = new ConnectionPool('localhost', 27017, 4, {
    timeout: 100,
    noDelay: true
  });
