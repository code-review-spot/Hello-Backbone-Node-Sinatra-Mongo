...
exports.shouldCorrectlyHandleMultipleChunkGridStore = function(test) {
  var fs_client = new Db(MONGODB, new Server("127.0.0.1", 27017, {
    auto_reconnect: false
  }), {
    native_parser: (process.env['TEST_NATIVE'] != null)
  });
...
exports.shouldCorrectlyHandleUnlinkingWeirdName = function(test) {
  ...
  fs_client.open(function(err, fs_client) {
    fs_client.dropDatabase(function(err, done) {
      var gridStore = new GridStore(fs_client, "9476700.937375426_1271170118964-clipped.png", "w", {
        'root': 'articles'
      });
      gridStore.open(function(err, gridStore) {
        gridStore.write("hello, world!", function(err, gridStore) {
          gridStore.close(function(err, result) {
            ...
            fs_client.collection('articles.chunks', function(err, collection) {
              collection.count(function(err, count) {
                ...
                // Unlink the file
                GridStore.unlink(fs_client, '9476700.937375426_1271170118964-clipped.png', {
                  'root': 'articles'
...
exports.shouldCorrectlyWriteFileToGridStore = function(test) {
  ...
  var fileSize = fs.statSync('./test/gridstore/test_gs_weird_bug.png')
    .size;
  ...
  gridStore.open(function(err, gridStore) {
    ...
    gridStore.write(data, function(err, doc) {
      gridStore.close(function(err, doc) {
        ...
        new GridStore(client, doc._id, 'r')
