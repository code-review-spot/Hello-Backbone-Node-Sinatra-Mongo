...
exports['Should Correctly Generate an Insert Command'] = function(test) {
  ...
  var insert_command = new InsertCommand({
...
exports['Should Correctly Generate an Update Command'] = function(test) {
  ...
  var document = {
    name: 'peter pan junior'
  };
  // Create the command
  var update_command = new UpdateCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, full_collection_name, selector, document, flags);
  // assert the length of the binary
...
exports['Should Correctly Generate a Delete Command'] = function(test) {
  ...
  // Create the command
  var delete_command = new DeleteCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, full_collection_name, selector);
  // assert the length of the binary
...
exports['Should Correctly Generate a Get More Command'] = function(test) {
  ...
  // Create the command
  var get_more_command = new GetMoreCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, full_collection_name, numberToReturn, cursorId);
  // assert the length of the binary
...
exports['Should Correctly Generate a Kill Cursors Command'] = function(test) {
  ...
  // Create the command
  var kill_cursor_command = new KillCursorCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, cursorIds);
  // assert the length of the binary
...
exports['Should Correctly Generate a Query Command'] = function(test) {
  ...
  var query_command = new QueryCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, full_collection_name, options, numberToSkip, numberToReturn, query, null);
  // assert the length of the binary
  ...
  query_command = new QueryCommand({
    bson: new BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
  }, full_collection_name, options, numberToSkip, numberToReturn, query, {
    a: 1,
    b: 1,
    c: 1
  });
