var mongodb = process.env['TEST_NATIVE'] != null ? require('../../lib/mongodb')
  .native() : require('../../lib/mongodb')
  .pure();

var testCase = require('../../deps/nodeunit')
  .testCase,
  mongoO = require('../../lib/mongodb')
    .pure(),
  debug = require('util')
    .debug,
...
exports['Should Correctly Deserialize object'] = function(test) {
  ...
  var object = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(new Buffer(serialized_data, 'binary'));
...
exports['Should Correctly Deserialize object with all types'] = function(test) {
  ...
  var object = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(new Buffer(serialized_data, 'binary')); //, false, true);
  // Perform tests
...
exports['Should Serialize and Deserialize String'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(test_string, false, true);
  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(test_string));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(test_string, false, serialized_data2, 0);

  assertBuffersEqual(test, serialized_data, serialized_data2, 0);
  test.deepEqual(test_string, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
...
exports['Should Correctly Serialize and Deserialize Integer'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(test_number, false, true);
  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(test_number));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(test_number, false, serialized_data2, 0);
  assertBuffersEqual(test, serialized_data, serialized_data2, 0);
  test.deepEqual(test_number, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data));
  test.deepEqual(test_number, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
...
exports['Should Correctly Serialize and Deserialize null value'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(test_null, false, true);

  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(test_null));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(test_null, false, serialized_data2, 0);
  assertBuffersEqual(test, serialized_data, serialized_data2, 0);
...
exports['Should Correctly Serialize and Deserialize Integer'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(test_int, false, true);

  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(test_int));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(test_int, false, serialized_data2, 0);
  assertBuffersEqual(test, serialized_data, serialized_data2, 0);
  test.deepEqual(test_int.doc, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc);
  ...
  serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(test_int, false, true);
...
exports['Should Correctly Serialize and Deserialize Object'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);

  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(doc));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(doc, false, serialized_data2, 0);
  assertBuffersEqual(test, serialized_data, serialized_data2, 0);

  test.deepEqual(doc.doc.age, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc.age);
  test.deepEqual(doc.doc.name, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc.name);
  test.deepEqual(doc.doc.shoe_size, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc.shoe_size);
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Array'] = function(test) {
  ...
  var deserialized = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data);
...
exports['Should correctly deserialize a nested object'] = function(test) {
  ...
  test.deepEqual(doc.doc.doc, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc.doc);
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize A Boolean'] = function(test) {
  ...
  test.equal(doc.doc, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc);
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize a Date'] = function(test) {
  ...
  test.equal(doc.date, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc.date);
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Oid'] = function(test) {
  ...
  var doc2 = {
    doc: ObjectID.createFromHexString(doc.doc.toHexString())
  };
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);
  ...
  delete doc.doc.__id;
  test.deepEqual(doc, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data));
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Ordered Hash'] = function(test) {
  ...
  var decoded_hash = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data)
    .doc;
  var keys = [];
...
exports['Should Correctly Serialize and Deserialize Regular Expression'] = function(test) {
  ...
  var doc2 = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data);
...
exports['Should Correctly Serialize and Deserialize a Binary object'] = function(test) {
  ...
  var deserialized_data = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data);
...
exports["Should Correctly Serialize and Deserialize DBRef"] = function(test) {
  ...
  var doc = {
    dbref: new DBRef('namespace', oid, null)
  };
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);
...
exports['Should Correctly Serialize and Deserialize Long Integer'] = function(test) {
  var doc = {
    doc: Long.fromNumber(9223372036854775807)
  };
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);
  ...
  doc = {
    doc: Long.fromNumber(-9223372036854775)
  };
  serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);
  deserialized_data = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data);
  test.deepEqual(doc.doc, deserialized_data.doc);

  doc = {
    doc: Long.fromNumber(-9223372036854775809)
  };
  serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc, false, true);
  deserialized_data = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
...
exports['Should Always put the id as the first item in a hash'] = function(test) {
  ...
  var serialized_data = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(hash, false, true);

  var serialized_data2 = new Buffer(new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .calculateObjectSize(hash));
  new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serializeWithBufferAndIndex(hash, false, serialized_data2, 0);
  assertBuffersEqual(test, serialized_data, serialized_data2, 0);
...
exports['Should handle complicated all typed object'] = function(test) {
  ...
  var serialized_data2 = new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .serialize(doc2, false, true);

  for (var i = 0; i < serialized_data2.length; i++) {
    require('assert')
      .equal(serialized_data2[i], serialized_data[i])
  }
...
exports['Should Correctly Serialize/Deserialize complicated object'] = function(test) {
  ...
  var doc2 = new BSONSE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey])
    .deserialize(serialized_data);
...
exports['ObjectID should correctly retrieve timestamp'] = function(test) {
  ...
  test.equal(Math.floor(testDate.getTime() / 1000), Math.floor(object1.getTimestamp()
    .getTime() / 1000));
  test.done();
}
