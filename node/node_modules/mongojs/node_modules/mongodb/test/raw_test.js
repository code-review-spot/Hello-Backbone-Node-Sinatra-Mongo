...
exports.shouldCorrectlyRemoveDocumentAndReturnRaw = function(test) {
  client.createCollection('shouldCorrectlyRemoveDocumentAndReturnRaw', function(err, collection) {
    ...
    collection.insert([{
      ...
      collection.remove(rawQueryObject, {
        safe: true
...
exports.shouldCorrectlyUpdateDocumentAndReturnRaw = function(test) {
  client.createCollection('shouldCorrectlyUpdateDocumentAndReturnRaw', function(err, collection) {
    ...
    collection.insert([{
      ...
      // Update the document and return the raw new document
      collection.update(rawSelectorObject, rawUpdateObject, {
        safe: true
...
exports.shouldCorreclyInsertRawDocumentAndRetrieveThem = function(test) {
  client.createCollection('shouldCorreclyInsertRawDocumentAndRetrieveThem', function(err, collection) {
    ...
    collection.insert(serializedObjects, {
      safe: true
    }, function(err, result) {
      test.equal(null, err);
...
exports.shouldCorrectlyPeformQueryUsingRaw = function(test) {
  client.createCollection('shouldCorrectlyPeformQueryUsingRaw', function(err, collection) {
    collection.insert([{
      ...
      collection.find(rawQueryObject, rawFieldsObject, {
        raw: true
      })
        .toArray(function(err, items) {
          ...
          collection.findOne(rawQueryObject, rawFieldsObject, {
            raw: true
          }, function(err, item) {
            test.equal(null, err);
            test.ok(item != null);
...
exports.shouldCorrectlyThrowErrorsWhenIllegalySizedMessages = function(test) {
  client.createCollection('shouldCorrectlyThrowErrorsWhenIllegalySizedMessages', function(err, collection) {
    ...
    try {
      collection.insert(illegalBuffer, {
        safe: true
      }, function(err, result) {});
    } catch (err) {
      test.ok(err.toString()
        .indexOf("insert") != -1);
    }
    ...
    try {
      collection.find(illegalBuffer)
        .toArray(function() {})
    } catch (err) {
      test.ok(err.toString()
        .indexOf("query selector") != -1);
    }
...
exports.shouldCorrectlyPeformQueryUsingRawSettingRawAtCollectionLevel = function(test) {
  client.createCollection('shouldCorrectlyPeformQueryUsingRawSettingRawAtCollectionLevel', function(err, collection) {
    collection.insert([{
      ...
      client.collection('shouldCorrectlyPeformQueryUsingRaw', {
        raw: true
...
exports.shouldCorreclyInsertRawDocumentAndRetrieveThemSettingRawAtCollectionLevel = function(test) {
  client.createCollection('shouldCorreclyInsertRawDocumentAndRetrieveThemSettingRawAtCollectionLevel', {
    raw: true
  }, function(err, collection) {
    // Create serialized insert objects
    var id = new ObjectID();
...
exports.shouldCorrectlyUpdateDocumentAndReturnRawSettingRawAtCollectionLevel = function(test) {
  client.createCollection('shouldCorrectlyUpdateDocumentAndReturnRawSettingRawAtCollectionLevel', {
    raw: true
  }, function(err, collection) {
    // Insert some documents
    collection.insert([{
