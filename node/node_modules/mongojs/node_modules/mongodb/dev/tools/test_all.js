...
var directories = [{
  ...
  {
    dir: __dirname + "/../../test/gridstore",
    path: "/test/gridstore/"
  },
  {
    dir: __dirname + "/../../test/connection",
    path: "/test/connection/"
  },
  {
    dir: __dirname + "/../../test/bson",
    path: "/test/bson/"
  }];
...
directories.forEach(function(dirEntry) {
  // Add the files
  files = files.concat(fs.readdirSync(dirEntry.dir)
...
// Replicasetfiles
var replicasetFiles = fs.readdirSync(__dirname + "/../../test/replicaset")
  .filter(function(item) {
    return /_test\.js$/i.test(item);
  })
  .map(function(file) {
