...
var Server = exports.Server = function(host, port, options) {
  ...
  Object.defineProperty(this, "queryStats", {
    enumerable: true,
    get: function() {
  ...
  Object.defineProperty(this, "runtimeStats", {
    enumerable: true,
    get: function() {
          ...
          if (callbackInfo.callback && Array.isArray(callbackInfo.info.chained)) {
            ...
            mongoReply.parseBody(message, connectionPool.bson, callbackInfo.info.raw, function(err) {
              ...
              if (server.recordQueryStats == true && server._state['runtimeStats'] != null && server._state.runtimeStats['queryStats'] instanceof RunningStats) {
                ...
                server._state.runtimeStats.queryStats.push(new Date()
                  .getTime() - callbackInfo.info.start);
              }
