...
var endHandler = function(self) {
  return function() {
    ...
    // Emit end event
    self.emit("end", {
      err: 'connection received Fin packet from [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'
    }, self);
  }
}
...
var timeoutHandler = function(self) {
  return function() {
    self.emit("timeout", {
      err: 'connection to [' + self.socketOptions.host + ':' + self.socketOptions.port + '] timed out'
    }, self);
  }
}
...
var errorHandler = function(self) {
  return function(err) {
    ...
    // Emit error
    self.emit("error", {
      err: 'failed to connect to [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'
    }, self);
  }
}
...
var closeHandler = function(self) {
  return function(hadError) {
    ...
    if (hadError && !self.connected) {
      ...
      // Emit close
      self.emit("close", {
        err: 'connection closed to [' + self.socketOptions.host + ':' + self.socketOptions.port + ']'
      }, self);
    }
  }
}
