 ...
 * @ignore
 */
var InsertCommand = require('./commands/insert_command')
  .InsertCommand,
  QueryCommand = require('./commands/query_command')
    .QueryCommand,
  DeleteCommand = require('./commands/delete_command')
    .DeleteCommand,
  UpdateCommand = require('./commands/update_command')
    .UpdateCommand,
...
Collection.prototype.remove = function remove(selector, options, callback) {
  ...
  var deleteCommand = new DeleteCommand(
    this.db, this.db.databaseName + "." + this.collectionName, selector);
...
var insertAll = function insertAll(self, docs, options, callback) {
  ...
  var insertCommand = new InsertCommand(
    self.db, self.db.databaseName + "." + self.collectionName, true, insertFlags);
...
Collection.prototype.update = function update(selector, document, options, callback) {
  ...
  var updateCommand = new UpdateCommand(
    this.db, this.db.databaseName + "." + this.collectionName, selector, document, options);
...
Collection.prototype.count = function count(query, callback) {
  ...
  var queryCommand = new QueryCommand(
    this.db, this.db.databaseName + ".$cmd", queryOptions, 0, -1, final_query, null
  );

  var self = this;
  this.db._executeQueryCommand(queryCommand, {
    read: true
  }, function(err, result) {
...
Collection.prototype.find = function find() {
  var options, args = Array.prototype.slice.call(arguments, 0),
    has_callback = typeof args[args.length - 1] === 'function',
    has_weird_callback = typeof args[0] === 'function',
    callback = has_callback ? args.pop() : (has_weird_callback ? args.shift() : null),
    len = args.length,
    selector = len >= 1 ? args[0] : {}, fields = len >= 2 ? args[1] : undefined;
  ...
  if (callback) {
    ...
    callback(null, new Cursor(this.db, this, selector, fields, o.skip, o.limit, o.sort, o.hint, o.explain, o.snapshot, o.timeout, o.tailable, o.batchSize, o.slaveOk, o.raw, o.read, o.returnKey, o.maxScan, o.min, o.max, o.showDiskLoc, o.comment));
  } else {
    return new Cursor(this.db, this, selector, fields, o.skip, o.limit, o.sort, o.hint, o.explain, o.snapshot, o.timeout, o.tailable, o.batchSize, o.slaveOk, o.raw, o.read, o.returnKey, o.maxScan, o.min, o.max, o.showDiskLoc, o.comment);
  }
};
...
Collection.prototype.findOne = function findOne() {
  ...
  var cursor = this.find.apply(this, args)
    .limit(1)
    .batchSize(1);
  // Return the item
...
Collection.prototype.indexes = function indexes(callback) {
  ...
  this.db.indexInformation(this.collectionName, {
    full: true
  }, callback);
}
