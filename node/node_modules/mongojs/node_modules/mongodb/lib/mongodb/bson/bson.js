  ...
  switch (typeof value) {
    ...
    case 'object':
      if (value == null || value instanceof MinKey || value instanceof MaxKey || value['_bsontype'] == 'MinKey' || value['_bsontype'] == 'MaxKey') {
        ...
        if (value.scope != null && Object.keys(value.scope)
          .length > 0) {
        ...
        return (name != null ? (Buffer.byteLength(name) + 1) : 0) + 1 + Buffer.byteLength(value.source, 'utf8') + 1 + (value.global ? 1 : 0) + (value.ignoreCase ? 1 : 0) + (value.multiline ? 1 : 0) + 1
      } else {
    ...
    case 'function':
      ...
      if (value instanceof RegExp || toString.call(value) === '[object RegExp]') {
        ...
        if (serializeFunctions && value.scope != null && Object.keys(value.scope)
          .length > 0) {
  ...
  while (true) {
    ...
    switch (elementType) {
      ...
      case BSON.BSON_DATA_DATE:
        ...
        // Set date object
        object[name] = new Date(new Long(lowBits, highBits)
          .toNumber());
        break;
